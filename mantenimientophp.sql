...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-09-2015 a las 19:53:29
...
--
-- Base de datos: `mantenimientophp`
--
...
CREATE TABLE IF NOT EXISTS `clientes` (
  `id` int(11) NOT NULL,
  `nombres` varchar(133) COLLATE utf8_spanish_ci NOT NULL,
  `apellidos` varchar(133) COLLATE utf8_spanish_ci NOT NULL,
  `tipo_doc` varchar(10) COLLATE utf8_spanish_ci NOT NULL,
  `nro` int(14) NOT NULL,
  `profesion_id` int(11) NOT NULL,
  `ocupacion` varchar(122) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `clientes` (`id`, `nombres`, `apellidos`, `tipo_doc`, `nro`, `profesion_id`, `ocupacion`, `nacionalidad_id`, `sexo`, `f_nac`, `est_civil`, `id_departamento`, `id_provincia`, `id_distrito`) VALUES
(1, 'dsfsdfdsfsdf', 'dsfsdffdsf', 'DNI', 23232323, 2, 'eeeeeee', 13, 'masculino', '2015-09-22', 'divorsiado', 0, 0, 0),
(2, 'dsfsdfdsfsdf', 'sssssssssssssss', 'DNI', 23232323, 0, 'eeeeeee', 0, 'masculino', '2015-09-22', 'divorsiado', 0, 0, 0),
(3, 'dsfsdfdsfsdf', 'qwerty', 'DNI', 23232323, 1, 'eeeeeee', 13, 'masculino', '2015-09-22', 'divorsiado', 0, 0, 0),
(4, 'aaaa', 'bbbbb', 'DNI', 1232424, 1, 'ggggg', 4, 'masculino', '2015-09-28', 'divorsiado', 15, 127, 12);
...
INSERT INTO `empleados` (`id`, `nombres`, `apellidos`, `tipo_doc`, `nro`, `profesion_id`, `ocupacion`, `nacionalidad_id`, `sexo`, `f_nac`, `est_civil`, `id_departamento`, `id_provincia`, `id_distrito`) VALUES
(1, 'dsfsdfdsfsdf', 'dsfsdffdsf', 'DNI', 23232323, 2, 'eeeeeee', 13, 'masculino', '2015-09-22', 'divorsiado', 0, 0, 0),
(2, 'dsfsdfdsfsdf', 'sssssssssssssss', 'DNI', 23232323, 0, 'eeeeeee', 0, 'masculino', '2015-09-22', 'divorsiado', 0, 0, 0),
(3, 'dsfsdfdsfsdf', 'qwerty', 'DNI', 23232323, 1, 'eeeeeee', 13, 'masculino', '2015-09-22', 'divorsiado', 0, 0, 0),
(4, 'aaaa', 'bbbbb', 'DNI', 1232424, 1, 'ggggg', 4, 'masculino', '2015-09-28', 'divorsiado', 15, 127, 12);
...
CREATE TABLE IF NOT EXISTS `profesion` (
  `id` int(11) NOT NULL,
  `nombre` varchar(122) COLLATE utf32_spanish_ci NOT NULL
